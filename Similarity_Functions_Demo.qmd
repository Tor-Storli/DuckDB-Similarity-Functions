...
### Prefix Bonus
$\text{Prefix Bonus} = l \times p \times 100$
...
**Prefix bonus:** $2 \times 0.1 \times 100 = 2.0$ (Note: table shows 1.33, suggesting different calculation)
...
**Prefix bonus:** $2 \times 0.1 \times 100 = 2.0$ (Note: table shows 0.74, suggesting different calculation)
